...
| Command | Description |
|---------|-------------|
| `/plannotator-review [--git] [--auto-run-analysis]` | Open code review UI for current changes or a GitHub PR; `--git` forces Git in JJ workspaces and `--auto-run-analysis` starts analysis immediately |
